...
export default function () {
    return (
        ...
        <section className="blocksBg">
        <div className="uk-container">
           
    
                <div className="uk-width-1-1 uk-padding uk-margin-large-top">
                          <div className="uk-flex uk-flex-center">
                            <div className="mediumContainer">
                                <h1 className="uk-text-bold uk-text-center">Why choose <span className="greenText">Virtual 1-on-1</span> Computer Courses</h1>
                 ...
                 <div className="uk-flex uk-flex-center ">
                    <div className="mediumContainerLarge">
                        ...
                        <div>
                            <div class="uk-card height250 uk-card-default borderRadius  uk-card-body">
                                <h6 className="uk-text-bold uk-text-center uk-margin-top greenText">Tech Expert Teachers</h6>
                                <p className="uk-text-center iconParagraphSmall">Our teachers come with expertise and experience and put it in the 
                        ...
                        <div>
                            ...
                            <h6 className="uk-text-bold uk-text-center uk-margin-top greenText">Customized tech pathway for your child</h6>
                                <p className="uk-text-center iconParagraphSmall">1-on-1 time and attention to create the best and fastest way of building in-demand 
                        ...
                        <div>
                            ...
                            <h6 className="uk-text-bold uk-text-center  uk-margin-top greenText">Flexible scheduling and financial options</h6>
                                <p className="uk-text-center iconParagraphSmall">Enjoy rates and time slots to fit your demands. Get as many hours as you want, when
                    ...
                    <div className="mediumContainerLarge">
                        ...
                        <div>
                            <div class="uk-card height250 uk-card-default borderRadius uk-card-body">
                                ...
                                <p className="uk-text-center iconParagraphSmall">Creativity and programming principles are essential for the 
                        ...
                        <div>
                            ...
                            <h6 className="uk-text-bold uk-text-center uk-margin-top  greenText">Learn @home or anywhere</h6>
                                <p className="uk-text-center iconParagraphSmall">Flexibility is now essential. Education doesn’t have to
                        ...
                        <div>
                            ...
                            <h6 className="uk-text-bold  uk-text-center uk-margin-top  greenText">Schools partner up with us</h6>
                                <p className="uk-text-center iconParagraphSmall">Education providers support tech education. We teamed
