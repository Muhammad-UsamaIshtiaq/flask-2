...
if not os.path.isdir((app.config['APP_ROOT'] + app.config["UPLOAD_FOLDER"])):
	os.mkdir((app.config['APP_ROOT'] + app.config["UPLOAD_FOLDER"]))
if not os.path.isdir((app.config['APP_ROOT'] + app.config["UPLOAD_THUMB_FOLDER"])):
	os.mkdir((app.config['APP_ROOT'] + app.config["UPLOAD_THUMB_FOLDER"]))
